...
BlackboardScreeps.prototype = {
		...
		set: function(key, value, treeScope, nodeScope) {
			//console.log("BlackboardScreeps.set(%s, %s, %s, %s)", key, value, treeScope, nodeScope);
			var memory = this._getMemory(treeScope, nodeScope);
			memory[key] = value;
		},

		get: function(key, treeScope, nodeScope) {
			//console.log("BlackboardScreeps.get(%s, %s, %s)", key, treeScope, nodeScope);
			var memory = this._getMemory(treeScope, nodeScope);
			return memory[key];
		}
}

module.exports = BlackboardScreeps;